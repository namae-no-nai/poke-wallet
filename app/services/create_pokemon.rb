...
class CreatePokemon
  def self.call(pokemon, current_investor)
    new(pokemon, current_investor).create_pokemon
  end
  ...
  def add_log
    WalletLog.create(pokemon_name: @purchase.pokemon_name, pokemon_id: @purchase.pokemon_id,
                     investor_id: @current_investor.id, usd_value: @purchase.usd_value)
  end
